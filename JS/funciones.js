...
function validarLogin(email, password) {
    ...
    if (errorEmail)
        return crearResultadoValidacion(errorEmail);

    const errorPassword = validarPassword(password);
    if (errorPassword)
        return crearResultadoValidacion(errorPassword);
...
/**
 * Limpia el mensaje de error de un elemento (y lo oculta con la utilidad 'hidden' de Tailwind)
 */
